...
A1, {MIDI_CC::Expression_Controller, CHANNEL_2}
};


CCPotentiometer potentiometer5 {
A5, {MIDI_CC::Expression_Controller, CHANNEL_3}
};


CCPotentiometer potentiometer7 {
A7, {MIDI_CC::Expression_Controller, CHANNEL_4}
};

CCPotentiometer potentiometer12 {
A0, {MIDI_CC::Expression_Controller, CHANNEL_13}
};


CCPotentiometer potentiometer32 {
A1, {MIDI_CC::Expression_Controller, CHANNEL_14}
};


CCPotentiometer potentiometer52 {
A5, {MIDI_CC::Expression_Controller, CHANNEL_15}
};


CCPotentiometer potentiometer72 {
A7, {MIDI_CC::Expression_Controller, CHANNEL_16}
};
...
void loop() {
  ...
  if(pressed1 == 1 && val < 100) {
    ...
    if(pressed2 == 0 && val1 > 100 ) {
    usbMIDI.sendNoteOff(59,66, 2);
    usbMIDI.sendNoteOn(59, 66, 2);
    pressed2 = 1;
  }
  if(pressed2 == 1 && val1 < 100) {
    usbMIDI.sendNoteOff(59,66,2);
    pressed2 = 0;
  }
    if(pressed3 == 0 && val5 > 100 ) {
    usbMIDI.sendNoteOff(66,66,3);
    usbMIDI.sendNoteOn(66, 66, 3);
    pressed3 = 1;
  }
  if(pressed3 == 1 && val5 < 100) {
    usbMIDI.sendNoteOff(66,66,3);
    pressed3 = 0;
  }
      if(pressed4 == 0 && val7 > 100 ) {
    usbMIDI.sendNoteOff(73,66,4);
    usbMIDI.sendNoteOn(73, 66, 4);
    pressed4 = 1;
  }
  if(pressed4 == 1 && val7 < 100) {
    usbMIDI.sendNoteOff(73,66,4);
    pressed4 = 0;
  }
  if(pressed12 == 0  && val > 100) {
    usbMIDI.sendNoteOff(52,66,13);
    usbMIDI.sendNoteOn(52, 66, 13);
    pressed12 = 1;
  }
 
  if(pressed12 == 1 && val < 100) {
    usbMIDI.sendNoteOff(52,66,13);
    pressed12 = 0;
  }
    if(pressed22 == 0 && val1 > 100 ) {
    usbMIDI.sendNoteOff(59,66,14);
    usbMIDI.sendNoteOn(59, 66, 14);
    pressed22 = 1;
  }
  if(pressed22 == 1 && val1 < 100) {
    usbMIDI.sendNoteOff(59,66,14);
    pressed22 = 0;
  }
    if(pressed32 == 0 && val5 > 100 ) {
    usbMIDI.sendNoteOff(66,66,15);
    usbMIDI.sendNoteOn(66, 66, 15);
    pressed32 = 1;
  }
  if(pressed32 == 1 && val5 < 100) {
    usbMIDI.sendNoteOff(66,66,15);
    pressed32 = 0;
  }
      if(pressed42 == 0 && val7 > 100 ) {
    usbMIDI.sendNoteOff(73,66,16);
    usbMIDI.sendNoteOn(73, 66, 16);
    pressed42 = 1;
  }
  if(pressed42 == 1 && val7 < 100) {
    usbMIDI.sendNoteOff(73,66,16);
    pressed42 = 0;
  }
